...
- Update the CMake `learning/roadmap.md` only when its stated exit evidence is met.
- Use `.agents/skills/cmake-coach/` for CMake-only coaching guidance. Keep generic coaching behavior in `.agents/skills/learning-coach/`.
